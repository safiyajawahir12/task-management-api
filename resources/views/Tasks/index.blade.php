...
<style>
  ...
  th, td { padding: 0.85rem 1rem; text-align:left; border-bottom: 1px solid #e5e7eb; font-size:0.9rem; }
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
  <div>
    ...
    <p style="color:#64748b; font-size:0.9rem;">Manage your tasks below.</p>
  </div>
...
<div class="card" style="padding:1rem; margin-bottom:1rem;">
  <form method="GET" action="{{ route('tasks.index') }}" style="display:flex; gap:0.75rem; flex-wrap:wrap; align-items:flex-end;">
    <div>
    ...
    <a href="{{ route('tasks.index') }}" class="btn" style="background:#6b7280;color:white;">Clear</a>
  </form>
</div>
...
<script>
  ...
  function openEditModal(id, title, description, status, priority, dueDate) {
    ...
    // Set the form action to the correct task route
